...
import { X, ShieldCheck, User, KeyRound, ExternalLink, Sparkles, CheckCircle2 } from 'lucide-react';
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-[#1A94FF]" /> Đăng nhập trải nghiệm nhanh
              </span>
            ...
            <button
              ...
              className="w-full bg-slate-50 hover:bg-blue-50/60 border border-slate-200 hover:border-[#1A94FF] rounded-lg p-3.5 flex items-center justify-between text-left transition-all group"
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-blue-100 text-[#1A94FF] flex items-center justify-center font-bold text-sm shrink-0">
              ...
              <CheckCircle2 className="w-5 h-5 text-slate-300 group-hover:text-[#1A94FF] transition-colors" />
            </button>
            ...
            >
              ...
              <CheckCircle2 className="w-5 h-5 text-slate-300 group-hover:text-indigo-600 transition-colors" />
            </button>
          </div>
          ...
          <div>
            <button
              ...
              className="w-full bg-[#1A94FF] hover:bg-[#0074DA] text-white font-bold py-3 px-4 rounded-md flex items-center justify-center gap-2 text-sm shadow-sm hover:shadow transition-all"
            >
              <KeyRound className="w-4 h-4" />
              Đăng nhập qua Keycloak SSO (OAuth2 / OIDC)
              <ExternalLink className="w-4 h-4" />
            </button>
            <p className="text-[11px] text-slate-400 text-center mt-2">
              Bảo mật chuẩn OpenID Connect với PKCE & JWT Token
            </p>
          </div>
        </div>
